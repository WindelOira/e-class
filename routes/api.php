...
Route::get('levels/{status}', 'API\LevelController@index')->where('status', '[a-z]+');
...
Route::get('classes/{status}', 'API\ClassesController@index')->where('status', '[a-z]+');
...
Route::get('subjects/{status}', 'API\SubjectController@index')->where('status', '[a-z]+');
...
Route::get('subject_tracks/{status}', 'API\SubjectTrackController@index')->where('status', '[a-z]+');
...
Route::get('strands/{status}', 'API\StrandController@index')->where('status', '[a-z]+');

Route::resource('tracks', 'API\TrackController')->except([
    'index', 'show', 'create', 'edit',
]);
Route::get('tracks/{track}', 'API\TrackController@show')->where('track', '[0-9]+');
Route::get('tracks/{status}', 'API\TrackController@index')->where('status', '[a-z]+');
...
Route::get('sections/{status}', 'API\SectionController@index')->where('status', '[a-z]+');
...
Route::get('academic_years/{status}', 'API\AcademicYearController@index')->where('status', '[a-z]+');
...
Route::get('attendances/{status}', 'API\AttendanceController@index')->where('status', '[a-z]+');
...
Route::get('grading_sheets/{status}', 'API\GradingSheetController@index')->where('status', '[a-z]+');
...
Route::get('grading_sheet_approvals/{status}', 'API\GradingSheetApprovalController@index')->where('status', '[a-z]+');
...
Route::get('computation_variables/{status}', 'API\ComputationVariableController@index')->where('status', '[a-z]+');
...
Route::get('students/{status}', 'API\StudentController@index')->where('status', '[a-z]+');
...
Route::get('users/{status}', 'API\UserController@index')->where('status', '[a-z]+');
